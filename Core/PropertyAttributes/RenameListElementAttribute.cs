...
public class ArrayElementTitleDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position,
                              ...
                              GUIContent label)
    {
        SerializedProperty newProperty = property;
        foreach (var name in Atribute.Varname)
        {
            string FullPathName = newProperty.propertyPath + "." + name;
            TitleNameProp = newProperty.serializedObject.FindProperty(FullPathName);
            newProperty = TitleNameProp;
        }
